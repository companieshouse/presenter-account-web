...
| [aws_lb.identity_lb](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/lb) | data source |
| [aws_lb_listener.identity_lb_listener](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/lb_listener) | data source |
...
| <a name="input_cloudwatch_alarms_enabled"></a> [cloudwatch\_alarms\_enabled](#input\_cloudwatch\_alarms\_enabled) | Whether to create a standard set of cloudwatch alarms for the service.  Requires an SNS topic to have already been created for the stack. | `bool` | `true` | no |
...
| <a name="input_presenter_account_web_version"></a> [presenter\_account\_web\_version](#input\_presenter\_account\_web\_version) | The version of the presenter account web container to run. | `string` | n/a | yes |
