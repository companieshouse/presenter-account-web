...
import { HomeRouter, HealthCheckRouter, CheckDetailsRouter, ApplyToFileOptionsRouter, YouCannotUseThisServiceRouter, EnterYourDetailsRouter, EnterYourDetailsPostRouter } from "./routers";
...
const routerDispatch = (app: Application) => {
    ...
    router.use(Urls.ENTER_YOUR_DETAILS, EnterYourDetailsRouter, EnterYourDetailsPostRouter);
